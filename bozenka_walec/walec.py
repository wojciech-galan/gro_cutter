...
FRAME_PATTERN_PLUS = 'Generated by trjconv((?!Generated by trjconv).)+Generated'
...
def get_frames(fname, pattern=FRAME_PATTERN, read_size=100, initial_pattern=FRAME_PATTERN_PLUS):
    found = False
    with open(fname) as f:
        # determine frame size
        while not found:
            s = f.read(read_size)
            found = re.search(initial_pattern, s, re.DOTALL)
            read_size = int(read_size*1.8)
        read_size = found.end
        print read_size
